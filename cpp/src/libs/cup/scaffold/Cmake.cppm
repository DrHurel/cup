...
[[nodiscard]] std::expected<void, utils::error::Error> ensure_line(
...
[[nodiscard]] std::expected<void, utils::error::Error> ensure_line_before(
    const std::filesystem::path& root, const std::filesystem::path& path, std::string_view line,
    std::string_view anchor);

// remove_line deletes every occurrence of the exact line, reporting whether any was
// removed.
[[nodiscard]] std::expected<bool, utils::error::Error> remove_line(
    const std::filesystem::path& root, const std::filesystem::path& path, std::string_view line);
...
[[nodiscard]] std::expected<bool, utils::error::Error> remove_matching_line(
...
[[nodiscard]] std::expected<void, utils::error::Error> append_block(
...
[[nodiscard]] std::expected<bool, utils::error::Error> remove_fetch_content_block(
...
[[nodiscard]] std::expected<void, utils::error::Error> add_module_source(
    const std::filesystem::path& root, const std::filesystem::path& path,
...
[[nodiscard]] std::expected<void, utils::error::Error> add_header_source(
    const std::filesystem::path& root, const std::filesystem::path& path,
    std::string_view filename);
...
[[nodiscard]] std::expected<void, utils::error::Error> ensure_header_lib_static(
    const std::filesystem::path& root, const std::filesystem::path& path, std::string_view name);
...
[[nodiscard]] std::expected<void, utils::error::Error> add_partition_import(
